...
\gll Me	dijeron	que	{a tu} primo,	que	\textsc{solo} \textsc{dos} \textsc{portatiles}	le	robaron\hspace{0.3cm}	\minsp{(} no	tres).\\
...
Me dijeron que \textsc{solo} \textsc{dos} \textsc{portatiles}, que le robaron a tu primo (no tres).
