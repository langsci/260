...
\gll Prosil 	je, 	če 	ko 	konča		z 	delom, 	če pospravi 	za 	sabo.\\
 request \textsc{aux} if.\textsc{decl}	when	finish		with	work		if clean\_up	after	yourself \\
...
request		\textsc{aux}	if.\textsc{decl}	when	finish	with	work	that 	clean\_up after	yourself\\
\trans `He asked if he could clean up after himself when he finishes with his work.'} 
\end{exe}
